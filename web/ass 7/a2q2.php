<?php
	...
	$conn=pg_connect("host=192.168.16.252 user=ty218550 dbname=ty218550 port=5432");
	if($conn)
		echo "connected <br>";
	...
	if($e1)
		echo "\n1st query has been executed and details as follows <br>";
	...
	if($e2)
		echo "\n2nd query has been executed <br>";
